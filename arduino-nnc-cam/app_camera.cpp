...
#define sensor_t cam_sensor_t // Avoid errors (sensor_t)
...
//! [ESP32_CAMERA] The most simplified version,
// #define ESP32_CAMERA
...
//#define WIFI_IP     192,168,0,90 // Fixed IP if defined, DHCP not definedd
...
#elif defined(ESP32_CAMERA)
#define PWDN_GPIO_NUM       -1 // 26
#define RESET_GPIO_NUM      32 // -1
#define XCLK_GPIO_NUM       0  // 32
#define SIOD_GPIO_NUM       26 // 13
#define SIOC_GPIO_NUM       27 // 12

#define Y9_GPIO_NUM         35 // 39
#define Y8_GPIO_NUM         34 // 36
#define Y7_GPIO_NUM         39 // 23
#define Y6_GPIO_NUM         36 // 18
#define Y5_GPIO_NUM         21 // 15
#define Y4_GPIO_NUM         19 // 4
#define Y3_GPIO_NUM         18 // 14
#define Y2_GPIO_NUM         5  // 5
#define VSYNC_GPIO_NUM      25 // 27
#define HREF_GPIO_NUM       23 // 25
#define PCLK_GPIO_NUM       22 // 19
#define AS312_PIN           -1 // 33
#define BUTTON_1            -1 // 34
...
void cam_setup()
{
    ...
    * firstly declair it as pullup input */
    ...
    config.xclk_freq_hz = 12000000; // 20000000;
    ...
    s->set_pixformat(s, PIXFORMAT_GRAYSCALE); // It is set to 1BPP/GRAYSCALE but it becomes 2BPP/YUV422
    s->set_framesize(s, (framesize_t)0);      // 0.QQVGA(160x120) 4.QVGA 6.VGA
...
#ifdef WIFI_IP
    WiFi.config(IPAddress(WIFI_IP), IPAddress(WIFI_GW), IPAddress(WIFI_MASK));
#endif
    Serial.println("");
