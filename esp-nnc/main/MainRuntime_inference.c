...
typedef struct {
    void *buffer_pool[2];
    void *param_pool[4];
    rt_buffer_allocate_type_t variable_buffers_allocate_type[8];
...
void* nnablart_mainruntime_allocate_context(void** params)
{
    ...
    allocate_sigmoid_local_context(&(c->f1));
    // Affine
...
int nnablart_mainruntime_free_context(void* context)
{
    ...
    free_sigmoid_local_context(&(c->f1));
